...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OculusXRHMD_EOculusXRColorMapType_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_OculusXRHMD_EOculusXRColorMapType_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OculusXRHMD_EOculusXRColorMapType_Statics::Enum_MetaDataParams))
	};
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_OculusXRHMD_EOculusXRPassthroughLayerOrder_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::Regular,
		METADATA_PARAMS(Z_Construct_UEnum_OculusXRHMD_EOculusXRPassthroughLayerOrder_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_OculusXRHMD_EOculusXRPassthroughLayerOrder_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Public_OculusXRPassthroughLayerShapes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Public_OculusXRPassthroughLayerShapes_h_Statics::EnumInfo[] = {
		{ EOculusXRColorMapType_StaticEnum, TEXT("EOculusXRColorMapType"), &Z_Registration_Info_UEnum_EOculusXRColorMapType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3510771663U) },
		{ EOculusXRPassthroughLayerOrder_StaticEnum, TEXT("EOculusXRPassthroughLayerOrder"), &Z_Registration_Info_UEnum_EOculusXRPassthroughLayerOrder, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 948422950U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Public_OculusXRPassthroughLayerShapes_h_1506385443(TEXT("/Script/OculusXRHMD"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Public_OculusXRPassthroughLayerShapes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Public_OculusXRPassthroughLayerShapes_h_Statics::EnumInfo));
