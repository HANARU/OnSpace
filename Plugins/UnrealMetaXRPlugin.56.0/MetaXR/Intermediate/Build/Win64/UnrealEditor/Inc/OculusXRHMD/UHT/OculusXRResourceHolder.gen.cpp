...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOculusXRResourceHolder_Statics::NewProp_PokeAHoleMaterial = { "PokeAHoleMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UOculusXRResourceHolder, PokeAHoleMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOculusXRResourceHolder_Statics::NewProp_PokeAHoleMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusXRResourceHolder_Statics::NewProp_PokeAHoleMaterial_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UOculusXRResourceHolder_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UOculusXRResourceHolder_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusXRResourceHolder_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Private_OculusXRResourceHolder_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Private_OculusXRResourceHolder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRResourceHolder, UOculusXRResourceHolder::StaticClass, TEXT("UOculusXRResourceHolder"), &Z_Registration_Info_UClass_UOculusXRResourceHolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRResourceHolder), 390532705U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Private_OculusXRResourceHolder_h_3627571678(TEXT("/Script/OculusXRHMD"),
		Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Private_OculusXRResourceHolder_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OnSpace_Plugins_UnrealMetaXRPlugin_56_0_MetaXR_Source_OculusXRHMD_Private_OculusXRResourceHolder_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
